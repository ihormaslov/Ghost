...
module.exports = {
    posts: {
        ...
        audio: {type: 'string', maxlength: 2000, nullable: true, validations: {isLength: {max: 2000}}},
        ...
        relevant_role: {type: 'text', maxlength: 2000, nullable: true}
    },
    posts_meta: {
        id: {type: 'string', maxlength: 24, nullable: false, primary: true},
    ...
    users: {
        id: {type: 'string', maxlength: 24, nullable: false, primary: true},
        expert_id: {type: 'string', maxlength: 2000, nullable: true},
        ...
        current_role: {type: 'string', maxlength: 2000, nullable: true},
        bio: {type: 'text', maxlength: 65535, nullable: true, validations: {isLength: {max: 65535}}},
    ...
    posts_experts: {
        id: {type: 'string', maxlength: 24, nullable: false, primary: true},
        post_id: {type: 'string', maxlength: 24, nullable: false, references: 'posts.id'},
        expert_id: {type: 'string', maxlength: 24, nullable: false, references: 'users.id'},
        sort_order: {type: 'integer', nullable: false, unsigned: true, defaultTo: 0}
    },
    roles: {
        id: {type: 'string', maxlength: 24, nullable: false, primary: true},
